...
class AuthRepositoryImpl(
    ...
    override suspend fun signInWithGoogle(idToken: String): AuthResult {
        return try {
            ...
            if (existingUser != null) return AuthResult.Success(existingUser)
            ...
            AuthResult.Success(FamUser(uid = uid, email = email, name = name, role = UserRole.CLIENT))
        } catch (e: Exception) {
    ...
    private suspend fun fetchUserFromFirestore(uid: String): FamUser? {
        return try {
            ...
            FamUser(
                ...
                email     = doc.get("email")    ?: "",
                name      = doc.get("name")     ?: "",
                role      = UserRole.valueOf(doc.get<String>("role") ?: UserRole.CLIENT.name),
